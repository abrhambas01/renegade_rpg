			...
			<section id="accountOption">
				<div id="user-option" class="mt-4">
					<div class="flex w-full font-sans">		
						<a href="/missions" id="registerOption" class="hover:bg-bodycolor hover:no-underline font-semibold p-4 w-1/6 text-xl font-sans mr-4 text-black bg-switchcolor text-center text-white">
							Browse Missions
						</a>
						<a href="/login" class="font-sans hover:no-underline hover:text-blue-700 font-semibold w-1/6 text-xl p-4 text-black text-center w-1/6 bg-white ">
							Login
						</a>
					</div>
				</div>
